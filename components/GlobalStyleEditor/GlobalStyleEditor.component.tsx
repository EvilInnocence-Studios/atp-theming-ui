...
import { generateCss, scales, stops } from "./util";
...
export const GlobalStyleEditorComponent = overridable(({classes = styles, theme, updater}:GlobalStyleEditorProps) => {
    ...
    const addBaseVariables = () => {
        const baseVariables = [
            { name: 'base', value: '#3b82f6', type: 'color' },
            { name: 'secondary', value: '#10b981', type: 'color' },
            { name: 'neutral', value: '#6b7280', type: 'color' },
            ...
            { name: 'success', value: '#22c55e', type: 'color' },
            { name: 'warning', value: '#eab308', type: 'color' },
            { name: 'error', value: '#ef4444', type: 'color' },
            { name: 'info', value: '#0ea5e9', type: 'color' },
