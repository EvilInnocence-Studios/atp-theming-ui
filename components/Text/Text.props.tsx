...
export const TextPropEditor = ({markdown, inline, raw}: ITextInputProps, _updateProps: (props: any) => void, updateProp: (prop: string) => (value: any) => void) => {
    return <>
        <Card size="small" title="Text">
            ...
            <Checkbox checked={raw} onChange={(e) => updateProp("raw")(e.target.checked)} >Raw</Checkbox>
        </Card>
    </>;
};